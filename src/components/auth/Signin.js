...
import { authenticate, isAuth } from "./Util";
    ...
    <div className="row">
      ...
      <div className="col-10 mx-auto ">
        ...
        <div className="col-lg-5 order-1 order-lg-1 header-img">
         <img src="https://www.tutorix.com/images/login-punch.png" className="img-fluid animated" 
         style={{marginTop:"30px"}} alt="home img"/>
         </div>
